function [P, J] = pattern_analys(cIM, initPos, thresVal, maxDist, tfMean, tfFillHoles, tfSimplify)
...
disp(['pattern_analys Opening: Initial position (' num2str(initPos(1))...
...
disp(['pattern_analys Ending: Found ' num2str(length(find(J)))...
